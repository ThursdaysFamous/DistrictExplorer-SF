...
const EXPECT_LAYERS = 14; // Thread-5: legislative chambers now pre-built SF-clipped geometry (data/app); 11 layers total; + 3 amenity nearest-point layers (post-office, library, early-voting) = 14
